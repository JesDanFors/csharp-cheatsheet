...
Script Execution Order | The knowledge of in which order your code is executed, top to bottom | ´i= 1;
console.WriteLine(i);
i++; //Output = 1` | [Script execution] (https://github.com/marczaku/csharp-basics/blob/main/slides/003.3.1-console-basics-1.md#0-Script-Execution)
Formatting | ? | ? | ?
`Console.WriteLine` | ? | ? | ?
`Console.Write` | ? | ? | ?
Multi-Line Comment | ? | ? | ?
